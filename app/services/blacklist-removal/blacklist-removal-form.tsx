...
interface FormData {
  ...
  siteCleanStatus: 'yes' | 'no' | 'dont_know';
  numberOfSites: number;
}

const BASE_PRICE = 79;

export default function BlacklistRemovalForm() {
  ...
  useEffect(() => {
    setPrice(BASE_PRICE * form.numberOfSites);
  }, [form.numberOfSites]);
      ...
      <div className='space-y-4'>
        ...
        <label className='block'>
          ...
          <textarea
            ...
            required
            rows={4}
            placeholder='Describe the blacklist issues or affected vendors...'
            className='block bg-slate-800 mt-1 px-3 py-2 border border-slate-600 rounded-md focus:ring-blue-500 w-full'
          />
        </label>
        ...
        <div className='gap-4 grid grid-cols-1 md:grid-cols-2'>
          <label className='block'>
            <span className='text-slate-300 text-sm'>
              How did you notice the blacklist? *
            </span>
            <select
              name='blacklistNotice'
              value={form.blacklistNotice}
              onChange={handleChange}
              required
              className='block bg-slate-800 mt-1 px-3 py-2 border border-slate-600 rounded-md focus:ring-blue-500 w-full'>
              ...
              {[
                ...
                'Browser blocking the site',
                'Email bounce backs',
                'Traffic drop in analytics',
        ...
        <div className='gap-4 grid grid-cols-1 md:grid-cols-2'>
          <label className='block'>
            <span className='text-slate-300 text-sm'>Is your site clean?</span>
            <select
              name='siteCleanStatus'
              value={form.siteCleanStatus}
              onChange={handleChange}
              className='block bg-slate-800 mt-1 px-3 py-2 border border-slate-600 rounded-md focus:ring-blue-500 w-full'>
